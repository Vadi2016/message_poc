...
import 'package:message_poc/group_channel_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        centerTitle: true,
        leading: BackButton(color: Theme
            .of(context)
            .buttonColor),
        title: Text(
          'Select members',
            ...
            onPressed: () {
              ...
              createChannel(
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => GroupChannelView(channel),
                  ),
                );
              }).catchError((error) {
                print(
          ...
          return CheckboxListTile(
            ...
            onChanged: (value) {
              ...
              setState(() {
                ...
                print(
                    'create_channel_view: on change for: ${user
                        .nickname} _selectedUsers: $_selectedUsers');
              });
            },
            secondary: user.profileUrl!.isEmpty
                ...
                : CircleAvatar(
              backgroundImage: NetworkImage(user.profileUrl as String),
            ),
          );
        });
  }
